            ...
            <div class="row">
                ...
                """)))}/*70.19*/else/*70.24*/{_display_(Seq[Any](format.raw/*70.25*/("""
                    ...
                    <div class="span9 form-horizontal text-right">
                        <form action=""""),_display_(Seq[Any](/*76.40*/routes/*76.46*/.Lobby.readLoginForm())),format.raw/*76.68*/("""" method="post">
                            ...
                            <a class="btn btn-warning" href=""""),_display_(Seq[Any](/*80.63*/routes/*80.69*/.Lobby.signup())),format.raw/*80.84*/("""">Sign up</a>
                        </form>
                    </div>
                """)))})),format.raw/*83.18*/("""
            </div>
